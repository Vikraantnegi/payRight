...
export function SavingsChart({ oldRegime, newRegime }: SavingsChartProps) {
  ...
  const monthlySavings = Math.abs(oldRegime.monthlyInHand - newRegime.monthlyInHand);
  const yearlySavings = Math.abs(oldRegime.yearlyInHand - newRegime.yearlyInHand);
