...
export function DeductionsForm() {
  ...
  const validateField = (field: string, value: number) => {
    ...
    if (
      ...
      if (current80C > 150000) {
        errors[field] =
          `Total 80C deductions exceed ₹1.5L limit (Current: ₹${current80C.toLocaleString('en-IN')})`;
      } else {
        delete errors[field];
      }
    }
  ...
  const calculateTotal80C = () => {
    ...
    return eightyCFields.reduce(
      (sum, field) => sum + (deductions[field as keyof typeof deductions] || 0),
      0
    );
  };
  ...
  const getDeductionsBreakdown = () => {
    ...
    categories.forEach(category => {
      const categoryTotal = category.fields.reduce(
        (sum, field) =>
          sum + (deductions[field as keyof typeof deductions] || 0),
        0
      );
      if (categoryTotal > 0) {
        breakdown.push({
        ...
        <div className='flex items-center space-x-2 text-xs text-gray-500'>
          ...
          <span>
            {completionPercentage >= 100
              ...
              : 'Fill in deductions to maximize tax savings'}
          </span>
        </div>
      </div>
      ...
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <Input
            ...
            className={
              validationErrors.lifeInsurance ? 'ring-2 ring-red-200' : ''
            }
          />
          ...
          <Input
            ...
            className={
              validationErrors.homeLoanPrincipal ? 'ring-2 ring-red-200' : ''
            }
          />
          ...
          <Input
            ...
            className={
              validationErrors.sukanyaSamriddhi ? 'ring-2 ring-red-200' : ''
            }
          />
          ...
          <Input
            ...
            className={
              validationErrors.taxSavingFd ? 'ring-2 ring-red-200' : ''
            }
          />
        </div>
      </div>
      ...
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          <Input
            ...
            className={
              validationErrors.healthInsuranceSelf ? 'ring-2 ring-red-200' : ''
            }
          />
          ...
          <Input
            ...
            onChange={value =>
              handleInputChange('healthInsuranceParents', value)
            }
            placeholder='Enter premium amount'
            helperText='Limit: ₹50,000'
            error={validationErrors.healthInsuranceParents}
            className={
              validationErrors.healthInsuranceParents
                ? 'ring-2 ring-red-200'
                : ''
            }
          />
          ...
          <Input
            ...
            onChange={value =>
              handleInputChange('preventiveHealthCheckup', value)
            }
            placeholder='Enter amount'
        ...
        <div className='flex items-start space-x-3'>
          ...
          <div className='text-sm text-amber-800'>
            ...
            <ul className='space-y-1 text-xs'>
              <li>
                • 80C limit is ₹1.5L - prioritize high-return options like ELSS
              </li>
              <li>• NPS offers additional ₹50K deduction beyond 80C</li>
              <li>
                • Health insurance premiums are fully deductible under 80D
              </li>
