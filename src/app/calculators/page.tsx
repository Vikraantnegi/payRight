...
const calculators = [
  {
    ...
    color: 'blue',
    longDescription:
      'Make informed decisions about your tax strategy with comprehensive comparisons, visual charts, and personalized recommendations.',
  },
  {
    id: 'hra',
    ...
    color: 'green',
    longDescription:
      'Maximize your tax savings through HRA optimization with two calculation scenarios and city-based limits.',
  },
  {
    id: 'salary',
    ...
    color: 'purple',
    longDescription:
      'Get complete visibility into your salary structure with pre-tax and post-tax calculations.',
  },
];
      ...
      <div className='relative max-w-7xl mx-auto px-4 py-16 space-y-16'>
        ...
        <div className='text-center space-y-6'>
          ...
          <p className='text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed opacity-80'>
            Comprehensive tools to help you plan your finances, optimize taxes,
            and understand your salary structure
          </p>
        </div>
            ...
            {calculators.map(calculator => {
              ...
              return (
                <div
                  key={calculator.id}
                  onClick={() =>
                    setActiveCalculator(calculator.id as CalculatorType)
                  }
        ...
        {getActiveCalculatorData() && (
          <div className='text-center space-y-4'>
            <div
              className={`inline-flex items-center space-x-3 px-6 py-3 rounded-2xl ${
        ...
        {/* Active Calculator */}
        <div className='space-y-8'>{getActiveCalculator()}</div>
