  ...
  const features = [
    {
      ...
      description:
        'Updated for AY 2026-27 with latest tax slabs and regulations',
    },
    {
  ...
  const calculators = [
    {
      ...
      description:
        'Make informed decisions about your tax strategy. Compare both regimes side-by-side with detailed breakdowns, visual charts, and personalized recommendations.',
      icon: CalculatorIcon,
      color: 'blue',
      features: [
        'AY 2026-27 Updated',
    ...
    },
    {
      ...
      description:
        'Maximize your tax savings through HRA optimization. Calculate required rent, understand exemptions, and get actionable insights for better financial planning.',
      icon: HomeIcon,
      color: 'green',
      features: [
    ...
    },
    {
      ...
      description:
        'Get complete visibility into your salary structure. Calculate pre-tax and post-tax earnings with detailed breakdowns of all components and deductions.',
      icon: BanknotesIcon,
      color: 'purple',
      features: [
        ...
        <div className='relative max-w-7xl mx-auto px-4 py-24 lg:py-32'>
          <div className='text-center space-y-8'>
            ...
            <p className='text-2xl lg:text-3xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-light'>
              Comprehensive financial tools to help you{' '}
        ...
        <div className='max-w-7xl mx-auto px-4'>
          ...
          <div className='text-center space-y-6 mb-20'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Three powerful calculators designed to give you complete control
              over your financial planning
            </p>
          </div>
              ...
              >
                ...
                >
                  <div className='relative group'>
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${getColorClasses(calculator.color)} rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300`}
                    />
                    <div
                      className={`relative bg-gradient-to-br ${getColorClasses(calculator.color)} rounded-3xl p-8 shadow-2xl transform group-hover:scale-105 transition-all duration-300`}
                    >
                ...
                >
                  <div className='space-y-6'>
                    ...
                    <div className='inline-flex items-center space-x-2 px-4 py-2 bg-gray-100 rounded-full'>
                      <calculator.icon
                        className={`h-5 w-5 text-${calculator.color}-600`}
                      />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {features.map((feature, index) => (
              <div
                ...
                className='bg-white p-8 rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105'
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${getColorClasses('blue')} rounded-2xl flex items-center justify-center mb-6`}
                >
      ...
      <div className='py-24 bg-gradient-to-br from-blue-600 to-indigo-700'>
        <div className='max-w-4xl mx-auto text-center px-4'>
          ...
          <p className='text-xl text-blue-100 mb-8 leading-relaxed'>
            Join thousands of users who trust Pay Right for their financial
            planning needs
          </p>
          <Link
            href='/calculators'
      ...
      <footer className='py-12 bg-gray-900'>
        <div className='max-w-7xl mx-auto px-4 text-center'>
          <div className='flex items-center justify-center space-x-4 mb-6'>
            ...
            <span className='text-2xl font-bold text-white'>Pay Right</span>
          </div>
          <p className='text-gray-400 mb-6'>
            Your comprehensive financial planning companion for tax
            optimization, salary analysis, and HRA calculations
          </p>
          <div className='flex flex-wrap justify-center items-center gap-6 text-sm text-gray-500'>
            <span>© 2025 Pay Right. All rights reserved.</span>
            <span>•</span>
